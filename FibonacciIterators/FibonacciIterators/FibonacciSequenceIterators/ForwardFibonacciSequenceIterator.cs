...
{
    /// <summary>
    /// Итератор по последовательности Фибоначчи в порядке возрастания.
    /// </summary>
    public class ForwardFibonacciSequenceIterator : IFibonacciSequenceIterator
    {
        /// <summary>
        ...
        /// <summary>
        /// Создать итератор по последовательности Фибоначчи в порядке возрастания.
        /// </summary>
        ...
        public ForwardFibonacciSequenceIterator(int start, int end, IFibonacciCalculator fibonacciCalculator)
        {
            if (start > end)
            {
                throw new ArgumentException("Стартовый элемент последовательности должен быть не больше конечного элемента.");
            }
